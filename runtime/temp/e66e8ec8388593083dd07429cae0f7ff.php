<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"E:\phpstudy2018\PHPTutorial\WWW\payment-system\public/../application/merchat\view\account\info.html";i:1534726750;s:95:"E:\phpstudy2018\PHPTutorial\WWW\payment-system\application\common\view\public\admin-header.html";i:1534684867;s:95:"E:\phpstudy2018\PHPTutorial\WWW\payment-system\application\common\view\public\admin-script.html";i:1534688156;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control " id="firstname" name="username"  required  data-bv-notempty-message="XXX不能为空" placeholder="请输入名字">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">必填+长度</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="lastname" name="ddsdsds" required  data-bv-notempty-message="XXX不dsdsds能为空" data-bv-stringlength="true" data-bv-stringlength-min="6" data-bv-stringlength-max="30" data-bv-stringlength-message="这个字段长度不得小于6，不得超过30 " placeholder="请输入姓">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">必填+两次一致</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  name="ddsdsds22" required  data-bv-notempty-message="必填+大小值不dsdsds能为空"  data-bv-identical="true" data-bv-identical-field="username" data-bv-identical-message="这个字段比一样" placeholder="请输入姓">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">邮箱</label>
                            <div class="col-sm-10">
                                <input type="email" class="form-control"  name="ssssss" required  data-bv-notempty-message="XXX不dsdsds能为空" data-bv-emailaddress-message="The input is not a valid email address">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">日期</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  name="454212" required  data-bv-notempty-message="XXX不dsdsds能为空" data-bv-date="true" data-bv-date-format="YYYY/MM/DD" data-bv-date-message="The birthday is not valid">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">数字</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  required  data-bv-notempty-message="数字不能为空" name="45421245454"  data-bv-digits="true"  data-bv-digits-message="its digits">
                            </div>
                        </div>
                        <div class="form-group">
                            <label  class="col-sm-2 control-label">金额</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  required  data-bv-notempty-message="金额不能为空" name="454212454545555"  data-bv-decimal="true"  data-bv-decimal-message="输入正确金额">
                            </div>
                        </div>
                        <div class="form-group" id="company_region">
                            <label  class="col-sm-2 control-label">公司省市</label>
                            <div class="col-sm-10 cxselect-list">
                                <select class="province form-control" name="region" data-value="浙江省" data-first-title="选择省" disabled="disabled" required data-required-msg="选择省"></select>
                                <select class="city form-control"  name="region" data-value="杭州市" data-first-title="选择市" disabled="disabled" required data-required-msg="选择市"></select>
                                <select class="area form-control"  name="region" data-value="西湖区" data-first-title="选择地区" disabled="disabled" required data-required-msg="选择地区"></select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input type="radio" name="optionsRadiosinline" required id="optionsRadios4"  value="option2" checked="checked">选项 2
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="optionsRadiosinline" required id="optionsRadios5"  value="option2">选项 2
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="radio-inline">
                                    <input type="checkbox" name="diosinline"  data-bv-choice="true" data-bv-choice-min="1" data-bv-choice-max="3" data-bv-choice-field="diosinline"  data-bv-choice-message="checkbox1-3" value="option2" checked="checked">选项 2
                                </label>
                                <label class="radio-inline">
                                    <input type="checkbox" name="diosinline"  data-bv-choice="true" data-bv-choice-min="1" data-bv-choice-max="3" data-bv-choice-field="diosinline"  data-bv-choice-message="checkbox1-3" value="option25">选项 2
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class=" form-control"  name="favor" multiple="multiple" data-bv-choice="true" data-bv-choice-min="1" data-bv-choice-max="3" data-bv-choice-field="favor"  data-bv-choice-message="1-3ge">
                                    <option>请选择</option>
