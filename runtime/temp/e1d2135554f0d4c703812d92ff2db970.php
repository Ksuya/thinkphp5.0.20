<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:103:"E:\phpstudy2018\PHPTutorial\WWW\payment-system\public/../application/merchat\view\account\withdraw.html";i:1534947034;s:95:"E:\phpstudy2018\PHPTutorial\WWW\payment-system\application\common\view\public\admin-header.html";i:1534855457;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" id="merchatWithdrawForm" action="<?php echo url('saveWithdraw'); ?>">
                ...
                <div class="modal-body">
                    <?php echo formInput('提现金额:','orderAmount','','text'); ?>
                    <?php echo formSelect('选择银行卡:','bankId',$merBanks,'id','openBank'); ?>
                    <?php echo formInput('持卡人姓名:','cardByName','','text'); ?>
                    <?php echo formInput('持卡人卡号:','cardByNo','','text'); ?>
                    <?php echo formInput('开户行:','openBank','','text'); ?>
                    ...
                    <?php echo formSelect('结算类型:','accType',[['id'=>0,'value'=>'对私'],['id'=>1,'value'=>'对公']],'id','value'); ?>
                </div>
