<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"E:\phpstudy2018\PHPTutorial\WWW\newtp\public/../application/merchat\view\account\withdraw.html";i:1534852977;s:86:"E:\phpstudy2018\PHPTutorial\WWW\newtp\application\common\view\public\admin-header.html";i:1534835935;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tb_departments').bootstrapTable({
                url: "<?php echo url('btData'); ?>",         //请求后台的URL（*）
                method: 'get',                      //请求方式（*）
