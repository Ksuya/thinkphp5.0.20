<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\phpStudy\PHPTutorial\WWW\payment\public/../application/shop\view\index\index.html";i:1535978470;s:76:"D:\phpStudy\PHPTutorial\WWW\payment\application\shop\view\public\header.html";i:1535978470;s:73:"D:\phpStudy\PHPTutorial\WWW\payment\application\shop\view\public\nav.html";i:1535978470;s:76:"D:\phpStudy\PHPTutorial\WWW\payment\application\shop\view\public\footer.html";i:1535978470;}*/ ?>
...
<div class="slideBox center">
    ...
    <div class="menuNav">
        ...
        <div class="navlist" id="SNmenuNav" >
            ...
            <dl>
                <dt class="icon03" ><a href=""><?php echo $v['name']; ?> </a></dt>
                <?php if(!empty($v['subNav'])): ?>
                <dd class="menv<?php echo $k; ?>">
                    <div class="menv0<?php echo $k; ?>_left">
                        <ul>
                            <?php foreach($v['subNav'] as $k2=>$v2): ?>
                            <li><a href="" title="<?php echo $v2['name']; ?>"><h3 style="color:#d51938; float:left;"><?php echo $v2['name']; ?></h3></a>
                                <br />
                            </li>
                            <?php endforeach; ?>
                        </ul>
